"""
Homepage for the World Cup 2026 Analysis and Predictions app.
Provides an overview of the app's purpose and a map of the host cities.
"""
...
st.set_page_config(
    page_title="Home - World Cup 2026 Analysis and Predictions",
    page_icon="👋",
...
st.markdown(
    ...
    Mexico, and Canada all hosting matches, it will be an exciting and busy time
    across the continent. If you’re looking for a tool to explore past performances
    or to see what machine learning can predict about future results, look no further.
...
tooltip = {
    "html": (
        "<b>{name}</b><br>Stadium: {stadium}<br>Capacity: {capacity}"
    ),
    "style": {
